...
public class Shockwave71712020EasyOpenCVYouTubeTest extends LinearOpMode {
	...
	public void runOpMode() throws InterruptedException {
		...
		while (opModeIsActive()) {
			...
			telemetry.addData("Position", getSkyStonePosition(valLeft, valMid, valRight));
...
//            moveDistance(0.4, 700);
	...
	static class StageSwitchingPipeline extends OpenCvPipeline
	{
		...
		public Mat processFrame(Mat input)
		{
			...
			Imgproc.circle(all, pointMid,5, new Scalar( 255, 100, 0 ),1 );//draws circle
	...
	public int getSkyStonePosition(int left, int mid, int right){
		if(left==0)
			return 1;
		else if(mid ==0)
			return 2;
